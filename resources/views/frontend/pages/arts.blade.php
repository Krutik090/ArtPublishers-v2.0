                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="wsus__featured_single">
                                <div class="wsus__featured_single_img">
                                    <img src="{{ asset($art->image) }}" alt="{{ $art->title }}" class="img-fluid w-100">
                                    <a href="#" class="love"><i class="fas fa-heart"></i></a>
                                    <a href="{{ route('arts',['category'=>$art->category->slag]) }}" class="small_text">{{ $art->category->name }}</a>
                                </div>
                                <a class="map" onclick="showArtModel('{{ $art->id }}')" data-bs-toggle="modal" data-bs-target="#exampleModal2"
                                ...
                                <div class="wsus__featured_single_text">
                                    ...
                                    <a href="{{ route('arts.show',$art->slug) }}">{{ truncate($art->title) }}</a>
                                    <p class="address">{{ $art->location->name }}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
