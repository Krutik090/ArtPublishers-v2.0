    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $delete = '<a href="' . route('admin.art-review.destroy', $query->id) . '" class="delete-item btn btn-md btn-danger ml-3" ><i class="fas fa-trash-alt"></i></a>';

                return  $delete;
            })
            ->addColumn('art', function ($query) {
                return $query->art->title;
            })
