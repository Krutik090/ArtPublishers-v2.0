            ...
            <div class="row">
                <div class="col-xl-6 col-md-7 d-none d-md-block">
                    <ul class="wsus__topbar_left">
                        ...
                        <li><a href="callto:+6958474522655"><i class="fal fa-phone-alt"></i>+91 9328068456</a></li>
                    </ul>
                </div>
                <div class="col-xl-6 col-md-5">
                    <div class="wsus__topbar_right">
                        <a href="{{ route('account.login') }}"><i class="fas fa-user"></i> Login</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="user_btn" href="dsahboard.html"><i class="far fa-plus"></i> add Arts</a>
            </div>
        </div>
    </nav>
    <!--==========================
