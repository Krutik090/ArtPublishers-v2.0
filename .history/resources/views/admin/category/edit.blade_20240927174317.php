                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="image-preview-2" class="image-preview bg-image">
                                                <label for="image-upload-2" id="image-label-2">Choose File</label>
                                                <input type="file" name="bg_image" id="image-upload-2" />
                                                <input type="hidden" name="old_icon" value="{{ $category->bg_image }}" />
...
@push('scripts')
    <script>
         $(document).ready(function() {
            $('.icon-image').css({
                'background-image': 'url({{ asset($category->avatar) }})',
                'background-size': 'cover',
                'background-position': 'center center'
            });

            $('.bg-image').css({
                'background-image': 'url({{ asset($category->banner) }})',
                'background-size': 'cover',
                'background-position': 'center center'
            });
        })
