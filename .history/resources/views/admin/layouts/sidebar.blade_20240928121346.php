...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <style>
        .sidebar-brand img {
            ...
            padding: 10px 0;
            /* Adds some padding above and below the image */
        }

        .sidebar-brand.sidebar-brand-sm img {
            width: 50px;
            /* Adjust the width for the smaller logo */
            height: auto;
            margin: 0 auto;
            padding: 5px 0;
        }
...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html"><img src="/default/sublogo1.png" alt="sublogo"></a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html"><img src="/default/logo.png" alt="logo"></a>
        </div>
        <ul class="sidebar-menu">
            ...
            {{-- ADMIN Dashboard --}}
            <li class="{{ setSidebarActive(['admin.dashboard']) }}"><a class="nav-link" href="{{ route('admin.dashboard') }}"> <i class="fas fa-chalkboard"></i><span>Dashboard</span></a></li>
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="{{ route('location.index') }}">Category</a></li>
            </ul>
            </li>
